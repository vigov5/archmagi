cards = [
  ...
  {"Defence", "+6 to wall", [bricks: 3], [{:me, {:add, :wall, 6}}]},
  {"Reserve", "+8 to tower, -4 to wall", [bricks: 3],
   [{:me, {:add, :tower, 8}}, {:me, {:sub, :wall, 4}}]},
  {"Tower", "+5 to tower", [bricks: 5], [{:me, {:add, :tower, 5}}]},
  {"School", "+1 to quarry", [bricks: 8], [{:me, {:add, :quarry, 1}}]},
  {"Wain", "+8 to tower, -4 to enemy tower", [bricks: 10],
   [{:me, {:add, :tower, 8}}, {:you, {:sub, :tower, 4}}]},
  ...
  {"Saboteur", "-4 enemy stocks", [recruits: 12],
   [{:you, {:sub, :bricks, 4}}, {:you, {:sub, :gems, 4}}, {:you, {:sub, :recruits, 4}}]},
  {"Clash", "-10 to enemy tower", [recruits: 18], [{:you, {:sub, :tower, 10}}]},
  ...
  {"Curse", "+1 to all, -1 to all enemies", [gems: 45],
   [
     {:you, {:sub, :bricks, 1}},
     {:you, {:sub, :gems, 1}},
     {:you, {:sub, :recruits, 1}},
...
Enum.map(cards, fn {name, desc, costs, effects} ->
